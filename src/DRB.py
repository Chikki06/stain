...
def define_backbone(opt, extra_blocks=None):
    ...
    backbone = BackboneWithFPN(resnet50(weights=ResNet50_Weights.IMAGENET1K_V1), return_layers=return_layers, in_channels_list=channels_list, out_channels=opt.ngf, extra_blocks=extra_blocks)
    return backbone
